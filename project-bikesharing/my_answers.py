...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        # input: 3 x 3, wih: 3 x 2, h_outputs: 1 x 2, who: 2 x 1, f_outputs: 1 x 1
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # TODO: Backpropagated error terms - Re
        # place these values with your calculations.
        output_error_term = error # Since oet = error*f'(x) and, for this case, f'(x) = 1 
